...
export default function ConfiguracoesProdPage() {
  ...
  const buscarConfiguracoes = async () => {
    try {
      setLoading(true);
      setError(null);
      const response = await fetch('/api/configuracoes?modo=PROD');
      if (!response.ok) {
  ...
  return (
    <div className="container mx-auto py-8">
      <h1 className="text-3xl font-bold mb-6">Configurações PROD</h1>
